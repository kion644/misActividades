...
export const ButtonGroupDetailPause = ({restablecer,guardar, isCompleted}:prop) => {
  ...
  return (
    <div className={classes.root}>
      <ButtonGroup variant="contained" color="primary" aria-label="contained primary button group">
        ...
        <ButtonDetails estilo={classes.buttonStyleGuardar} text={'Guardar'} disabled={isCompleted} onClick={() => guardar()} />
