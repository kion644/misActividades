...
import obtenerLicenciasEjecutadasAtencion from "../../../services/Licencias/obtenerLicenciasEjecutadasAtencion";
...
export default function LicenciasEjecutadasAtencion() {
  ...
  const handleChangeRowsPerPage = (
    ...
    useEffect(() => {
        ...
        async function loadDetails() {
            const response: any = await obtenerLicenciasEjecutadasAtencion()
            try {
