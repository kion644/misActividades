...
export default function TableBitacora({ id,  setChange }: props) {


    const classes = useStyles();
    const [loading, setLoading] = useState(true);
    const [cambie, setCambie] = useState(false);
    const [bit, setBitacora] = useState<mensaje[]>([]);
                    ...
                    <Table className={classes.table} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="center">Enviado a</StyledTableCell>
                        ...
                        <TableBody >
                            {bit.map((row: any) => (
                                ...
                                <StyledTableRow key={row.id} >
                                    ...
                                    <StyledTableCell align="center">{row.destinatario != null ? row.destinatario.nombre + ' ' + row.destinatario.apellido : ""}</StyledTableCell>
